...
const resources = {
    ...
    en: {
        translation: {
            ...
            "Type path or search term...": "Type path or search term",
            ...
            "To": "To",
            "Clear": "Clear",
            "(filtered by date: from {{startDate}} to {{endDate}})": "(filtered by date: from {{startDate}} to {{endDate}})",
            "(filtered by date: after {{date}})": "(filtered by date: after {{date}})",
            "(filtered by date: before {{date}})": "(filtered by date: before {{date}})",
    ...
    zh: { // 中文翻译
        translation: {
            ...
            "Search": "搜索",
            "Refreshing": "刷新中",
            "Type path or search term...": "输入路径或搜索项",
            ...
            "Type": "类型",
            "Modified": "修改时间",
            "Date filter active": "日期选择",
            "Add date filter": "添加日期过滤条件",
            "Select Date Range": "选择日期范围",
            "Clear Dates": "清除日期",
            "From": "从:",
            "To": "至:",
            "Clear": "清除",
            "(filtered by date: from {{start}} to {{end}})": "(日期过滤: 从 {{start}} 至 {{end}})",
            "(filtered by date: after {{date}})": "(日期过滤: {{date}} 之后)",
            "(filtered by date: before {{date}})": "(日期过滤: {{date}} 之前)",
